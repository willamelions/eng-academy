    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Primeiro Socorros</h5>
                    <h5 class="card-text">Primeiro atendimento Pré-Hospotalar (Primeiro Socorros.)</h5>
                    <a href="{{ route('login') }}" class="btn btn-primary">Acessar curso</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Segurança em Instalações e Serviços em Eletricidade</h5>
                    <h5 class="card-text">Curso de NR-10 Básico</h5>
                    <a href="{{ route('login') }}" class="btn btn-primary">Acessar curso</a>
                </div>
            </div>
        </div>
